...
public class GuiBlockRenderBuilder {
    ...
    public GuiBlockRenderBuilder(BlockState state, TileEntity tile, AirBlockReader reader) {
...
//        RenderSystem.disableRescaleNormal();
    ...
    public void finalize(MatrixStack ms) {
        ...
        brd.getBlockModelRenderer().renderModel(ms.getLast(), buf.getBuffer(RenderTypeLookup.func_239220_a_(blockState, false)), blockState, model, r, g, b, 0xF000F0, OverlayTexture.NO_OVERLAY, tile != null ? tile.getModelData() : EmptyModelData.INSTANCE);
